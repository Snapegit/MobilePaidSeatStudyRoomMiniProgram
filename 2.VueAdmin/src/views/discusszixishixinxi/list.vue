	...
	<div>
		<div class="app-contain">
			<div class="list_search_view">
				...
				<br>
				<div class="btn_view">
					<el-button type="success" @click="addClick" v-if="btnAuth('discusszixishixinxi','新增')">新增</el-button>
					<el-button type="primary" :disabled="selRows.length==1?false:true" @click="editClick" v-if=" btnAuth('discusszixishixinxi','修改')">修改</el-button>
			...
			<el-table
				...
				<el-table-column label="操作" width="300" :resizable='true' :sortable='true' align="left" header-align="left">
					<template #default="scope">
						<el-button v-if="btnAuth('discusszixishixinxi','查看评论')" type="warning" @click="commentClick(scope.row.id)">查看评论</el-button>
...
<script setup>
	...
	//基础信息
	const tableName = 'discusszixishixinxi'
	const formName = '自习室信息评论表'
	...
	const commentClick=(id)=>{
		context?.$router.push('/discussdiscusszixishixinxi?refid=' + id)
	}
