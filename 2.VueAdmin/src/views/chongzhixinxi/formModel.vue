		...
		<el-dialog v-model="formVisible" :title="formTitle" width="80%" destroy-on-close :fullscreen='false'>
			<el-form class="formModel_form" ref="formRef" :model="form" label-width="$template2.back.add.form.base.labelWidth" :rules="rules">
				<el-row>
					...
					<el-col :span="24">
						<el-form-item label="充值金额" prop="yue">
							<el-input class="list_inp" v-model="form.yue" placeholder="充值金额"
								 type="text" 								:readonly="!isAdd||disabledForm.yue?true:false" />
						</el-form-item>
					</el-col>
					...
					<el-col :span="24">
						<el-form-item label="充值时间" prop="chongzhishijian">
							<el-date-picker
								...
								type="datetime"
								:readonly="!isAdd||disabledForm.chongzhishijian?true:false"
								placeholder="请选择充值时间" />
						</el-form-item>
					</el-col>
				</el-row>
...
<script setup>
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		resetForm()
			form.value.chongzhishijian = context?.$toolUtil.getCurDateTime()
		if(formId){
			id.value = formId
			type.value = formType
		}
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='chongzhishijian'){
					form.value.chongzhishijian = row[x];
					disabledForm.value.chongzhishijian = true;
					continue;
				}
			}
			if(row){
